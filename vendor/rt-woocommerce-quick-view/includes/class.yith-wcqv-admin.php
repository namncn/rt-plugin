...
if ( ! class_exists( 'YITH_WCQV_Admin' ) ) {
	...
	class YITH_WCQV_Admin {
		...
		public function action_links( $links ) {
			...
			$links[] = '<a href="' . admin_url( "admin.php?page={$this->_panel_page}" ) . '">' . __( 'Cài đặt', 'yith-woocommerce-quick-view' ) . '</a>';
		...
		public function register_panel() {
			...
			$admin_tabs = array(
				'settings' => __( 'Cài đặt', 'yith-woocommerce-quick-view' ),
			...
			$args = array(
				...
				'parent_slug'      => '',
				'page_title'       => __( 'Xem nhanh', 'yith-woocommerce-quick-view' ),
				'menu_title'       => __( 'Xem nhanh', 'yith-woocommerce-quick-view' ),
