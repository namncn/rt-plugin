	...
	class CPT_Core {
		...
		public function get_args() {
			...
			$labels = array(
				...
				'add_new'            => sprintf( __( 'Thêm mới %s', 'cpt-core' ), $this->singular ),
				'add_new_item'       => sprintf( __( 'Thêm mới %s', 'cpt-core' ), $this->singular ),
				'edit_item'          => sprintf( __( 'Chỉnh sửa %s', 'cpt-core' ), $this->singular ),
				'new_item'           => sprintf( __( 'Thêm mới %s', 'cpt-core' ), $this->singular ),
				'all_items'          => sprintf( __( 'Tất cả %s', 'cpt-core' ), $this->plural ),
				'view_item'          => sprintf( __( 'Xem %s', 'cpt-core' ), $this->singular ),
				'search_items'       => sprintf( __( 'Tìm kiếm %s', 'cpt-core' ), $this->plural ),
				'not_found'          => sprintf( __( 'Không tìm thấy %s', 'cpt-core' ), $this->plural ),
				'Khoongt_found_in_trash' => sprintf( __( 'Không tìm thấy %s trong thùng rác', 'cpt-core' ), $this->plural ),
				'parent_item_colon'  => isset( $this->arg_overrides['hierarchical'] ) && $this->arg_overrides['hierarchical'] ? sprintf( __( 'Cha của %s:', 'cpt-core' ), $this->singular ) : null,
